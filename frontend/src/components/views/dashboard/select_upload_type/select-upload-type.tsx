  ...
  return (
    <>
      <div>
        ...
        <div className="js-upload uk-width-1-1 uk-margin-top" data-uk-form-custom>
          <button className="uk-button uk-button-primary uk-width-1-1" tabIndex={-1}>
            <input type="file" accept="image/*" onChange={handleImageUpload} className="uk-width-1-1" />
            {'Upload image'}
          </button>
        </div>

        <button className="uk-button uk-button-secondary uk-width-1-1 uk-margin-top" onClick={openWebcam}>
          {'Take picture'}
        </button>
      </div>
    </>
